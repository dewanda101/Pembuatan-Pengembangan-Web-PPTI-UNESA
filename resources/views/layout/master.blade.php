...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <!-- Header Bottom -->
{{-- <div class="header-bottom" style="background-color: #F0F0F0; height: 40px; display: flex; align-items: center; overflow: hidden;">
    <marquee behavior="scroll" direction="left" style="width: 100%;" scrollamount="7" scrolldelay="0">
        <h3 style="margin: 0; color: #000000; text-align: center;">
            Selamat Datang di Laman Admin TI & Pusat Data - Universitas Negeri Surabaya <span id="date-time" style="margin-left: 20px;"></span>
        </h3>
    </marquee>
</div>
...
<script>
    setInterval(() => {
        const now = new Date();
        document.getElementById("date-time").textContent = `${["Minggu", "Senin", "Selasa", "Rabu", "Kamis", "Jumat", "Sabtu"][now.getDay()]}, ${now.getDate()} ${["Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus", "September", "Oktober", "November", "Desember"][now.getMonth()]} ${now.getFullYear()} Jam ${now.getHours().toString().padStart(2, '0')}:${now.getMinutes().toString().padStart(2, '0')}:${now.getSeconds().toString().padStart(2, '0')}`;
    }, 1000);v4
</script> --}}
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="http://unesa.test/dashboard" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="http://unesa.test/kontak" class="nav-link">Contact</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">Admin TI </span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Dewanda Firmansyah C.P</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                <a href="/dashboard" class="nav-link {{ request()->is('dashboard') ? 'active' : '' }}"
                                    style="{{ request()->is('dashboard') ? 'background-color: blue; color: white;' : '' }}">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('news.index') }}"
                                    ...
                                    style="{{ request()->is('news') ? 'background-color: blue; color: white;' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Master Category</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="/kategori" class="nav-link {{ request()->is('kategori') ? 'active' : '' }}"
                                    style="{{ request()->is('kategori') ? 'background-color: blue; color: white;' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Master Item</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('kontak.index') }}"
                                    ...
                                    style="{{ request()->routeIs('kontak.index') ? 'background-color: blue; color: white;' : '' }}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Management Contact Us</p>
                                </a>
                            </li>
                            {{-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <form action="{{ route('admin.logout') }}" method="POST" style="display: inline;">
                                    @csrf
                                    <button type="submit" class="nav-link btn btn-link" style="color: red;">
