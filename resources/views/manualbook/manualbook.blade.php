			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<li class="nav-item dropdown">
						<li class="nav-item"> <a class="nav-link" href="{{ route('home') }}" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Beranda</a>
					...
					<li class="nav-item"> <a class="nav-link" href="{{ route('contact.index') }}">Contact us</a> </li>
					  ...
					  <li class="nav-item dropdown" id="documentDropdown">
						...
						<ul class="dropdown-menu custom-dropdown-menu">
							<li><a class="dropdown-item" href="{{ route('document.index') }}">User Manual Sistem
...
<!-- =======================
Main Banner START -->
<section class="bg-dark pt-sm-8 pb-9" data-bs-theme="dark" style="display: flex; justify-content: center; align-items: center; height: 77vh;">
    <div class="container">
        <!-- Hero START -->
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 text-center d-flex flex-column justify-content-center align-items-center">
                ...
                <h1 class="mb-0 lh-base">
                    <h2 style="color: #cfac32; " class="mt-3">Manual Book Sistem Informasi</h2>
                </h1>
                <h2 class="mt-3">Universitas Negeri Surabaya</h2> <!-- Mengurangi jarak antara elemen dengan mt-1 -->
            </div>
            <!-- Hero content END -->
        </div>
        <!-- Hero END -->
...
<main style="margin-top: 120px;">
    ...
    <div class="container mt-4">
        <div class="card shadow">
            <!-- Header Card -->
            {{-- <div class="card-header text-center" style="background-color: #003366; color: #FFD700;">
                <h4 class="mb-0">User Manual Sistem Informasi</h4>
            </div> --}}
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered">
                    <!-- Tabel Header -->
                    <thead style="background-color: #f4f4f4; color: #003366; text-align: center; font-weight: bold;">
                        <tr>
                            <th style="width: 5%;">No</th>
                            <th style="width: 30%;">Kategori Dokumen</th>
                            <th style="width: 30%;">URL Sistem Informasi</th>
                            <th style="width: 20%;">Link Sistem Informasi</th>
                        </tr>
                    </thead>
        <tbody>
            @foreach($manualbooks as $key => $manualbook)
            <tr>
                <td style="text-align: center;">{{ $key + 1 }}</td>
                <td>{{ $manualbook->kategori_dokumen }}</td>
                <td>{{ $manualbook->url_sistem_informasi }}</td>
              <!-- Link Sistem Informasi -->
              <td class="text-center align-middle">
                <a href="{{ $manualbook->link_sistem_informasi }}"class="btn btn-info btn-sm text-white" style="background-color: #003366; border-color: #003366;">
...
<!-- Add margin-bottom to provide space between form and footer -->
...
<div class="container position-relative mt-5">
    <div class="col-lg-3">
        <!-- Logo START -->
        <a class="navbar-brand me-0" href="#">
            <img class="navbar-brand-item" style="height: 90px;" src="{{ asset('images/logo/Logo-Unesa.png')}}" alt="logo">
        </a>
    </div>
    <div class="container mt-4">
        <div class="row">
    ...
    <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
        <!-- copyright text -->
        <div class="text-body"> Copyright © 2025 PPTI | Pusat Pengembangan Teknologi Informasi Universitas Negeri Surabaya. <br> Supported By PPTI Universitas Negeri Surabaya. </div>
        <!-- copyright links-->
        <!-- Language selector -->
