        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 text-center d-flex flex-column justify-content-center align-items-center">
                ...
                <h1 class="mb-0 lh-base">
                    <h2 style="color: #cfac32; " class="mt-3">User Manual Sistem Informasi </h2>
                </h1>
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr style="background-color: #ffffff;">
                            <!-- Nomor -->
                            <td class="text-center align-middle">{{ $manual->id }}</td>
    
                            <!-- Kategori Dokumen -->
                            <td class="align-middle ">{{ $manual->kategori_dokumen }}</td>
    
                            <!-- URL Sistem Informasi -->
                            <td class="align-middle text-center">
                                <a href="{{ $manual->url_sistem_informasi }}" target="_blank" style="color: #0056b3; text-decoration: none;">
                                    {{ $manual->url_sistem_informasi }}
                                </a>
                            </td>
    
                            <!-- Link Sistem Informasi -->
                            <td class="text-center align-middle">
                                <a href="{{ '/storage/' . $manual->link_sistem_informasi }}" class="btn btn-info btn-sm text-white" style="background-color: #003366; border-color: #003366;">
