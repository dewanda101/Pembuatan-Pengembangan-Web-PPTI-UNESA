...
<head>
    ...
    <style>
        ...
        #accessibility-menu ul li button .icon {
            width: 50px;
            height: 50px;
        ...
        /* Menu Aktif */
        #accessibility-container.active #accessibility-menu {
            left: 20px;
            /* Muncul ke layar */
        }
    </style>
                    ...
                    <ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
                        ...
                        <li class="nav-item dropdown" id="aboutDropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('document.index') }}">Struktur
                                        Organisasi</a></li>
                            </ul>
                        </li>
                                    ...
                                    <div class="col-xl-8 d-none d-xl-block">
                                        <div class="d-flex gap-4">
                                            ...
                                            <div class="card bg-transparent">
                                                <!-- Image -->
                                                <img src="assets/images/portfolio/list/01.jpg" class="card-img"
                                                    alt="">
                                                <!-- Card body -->
                                                <div class="card-body px-0 text-start pb-0">
                                                    <h6><a href="#">Ceremony Worthy of Time</a></h6>
                                                    <p class="mb-2 small">We help our customers better manage their web
                                                        presence.</p>
                                                    <a class="icon-link icon-link-hover stretched-link mb-0"
                                                        href="portfolio-case-studies-v1.html">Learn more<i
                        ...
                        <li class="nav-item dropdown" id="documentDropdown">
                            ...
                            <ul class="dropdown-menu custom-dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('user-manual.index') }}">User Manual
                                        Sistem
                                        Informasi (Lain-Lain)</a></li>
                                {{-- <li><a class="dropdown-item" href="{{ route('manualbook.index') }}">Information Manual Book</a></li> --}}
                            </ul>
                        </li>
...
Main Banner START -->
        <section class="bg-dark pt-sm-8 pb-9" data-bs-theme="dark">
            <div class="container pt-4 pt-sm-0">
                <!-- Hero START -->
                <div class="row g-4 g-xxl-5 mt-3">
                    <!-- Hero content START -->
                    <div class="col-lg-8">
                        <!-- Title -->
                        <h1 class="mb-0 lh-base"> <span style="color: #cfac32;">Information Technology</span>
                            Development Center Division</h1>
                        <p class="mb-0 mt-4">Sebagai pusat layanan dan pengembangan teknologi informasi dan komunikasi,
                            <br> yang handal dan berkualitas
                        </p>
                    </div>
                    <!-- Hero content END -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 position-relative ms-auto ps-xl-6 mt-6">
                        ...
                        <div class="card card-body overflow-hidden p-0">
                            <img src="images/about/gedung rektorat unesa (2) ai tulisan-.jpeg" class="card-img"
                                alt="video-img">
                            <div class="bg-overlay bg-dark opacity-3"></div>
                            <div class="card-img-overlay d-flex p-3">
                                <!-- Video button and link -->
                                <div class="m-auto">
                                    <a href="https://youtu.be/o3wWPdX9PbI?si=HM6tqV8vcRSjR54t"
                                        class="btn btn-lg btn-white btn-round stretched-link mb-0" data-glightbox=""
                            ...
                            <div class="card card-hover-shadow border h-100 p-4">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <figure class="text-primary mb-4">
                                        <svg style="color: #cfac32;" width="50" height="50"
                                    ...
                                    <!-- Content -->
                                    <h5 class="mb-3"><a href="#">{{ $index->nama }}</a>
                                    </h5>
                                    <p>{{ $index->deskripsi }}</p>
                                </div>
                            </div>
                    ...
                    {{-- <div class="col">
                        <div class="card card-hover-shadow border h-100 p-4">
                            ...
                            <div class="card-body p-0">
                                <!-- Icon -->
                                <figure class="text-primary mb-4">
                                    <svg style="color: #cfac32;" width="50" height="50" viewBox="0 0 24 24"
                                ...
                                <p>Divisi ini memiliki tanggung jawab untuk menjalin kerjasama secara intensif baik
                                    pihak internal ( antar Unit kerja) maupun pihak ekternal ( stakeholder, penyedia
                                    jasa TIK) dan membuat program peningkatan kualitas sumber daya manusia di bidang TIK
                                    serta berfokus pada layanan TIK.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card card-hover-shadow border h-100 p-4">
                            ...
                            <div class="card-body p-0">
                                ...
                                <p>Divisi pengembangan sistem informasi memiliki tanggung jawab untuk mengakomodasi
                                    semua ide pengembangan sistem informasi di universitas. </p>
                            </div>
                        </div>
                    </div> --}}
                </div>
        ...
        <section class="pt-0">
            <div class="container">
                ...
                <div class="row g-4 g-sm-5 g-xl-7 mt-0">
                    ...
                    @if ($news->isNotEmpty())
                        ...
                        @foreach ($news as $post)
                            <div class="col-md-6 col-lg-4">
                                <article class="card bg-transparent h-100 p-0">
                                    ...
                                    <!-- Card image -->
                                    <img src="{{ asset('storage/image/' . $post->image) }}" class="card-img"
                                        alt="Blog-img">
                                    ...
                                    <div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
                                        ...
                                        <a class="icon-link icon-link-hover stretched-link"
                                            href="{{ route('blog', $post->id) }}" style="color: #fdc800;">
                        ...
                        @endforeach
                    @else
                        <p style="font-style: italic">Tidak ada berita.</p>
                    @endif
				...
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0"></span>
						<a class="icon-link icon-link-hover stretched-link" href="{{ route('profil') }}">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0"></span>
						<a class="icon-link icon-link-hover stretched-link" href="{{ route('kontak') }}">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0"></span>
						<a class="icon-link icon-link-hover stretched-link" href="{{ route('drive') }}">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0"></span>
						<a class="icon-link icon-link-hover stretched-link" href="{{ route('frame') }}">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<div class="card-footer bg-transparent d-flex justify-content-between px-2 py-0">
						<span class="heading-color fw-semibold mb-0"></span>
						<a class="icon-link icon-link-hover stretched-link" href="{{ route('lensa') }}">Read more<i class="bi bi-arrow-right"></i> </a>
					</div>
				</article>
			</div> --}}
                </div>
    ...
    <footer class="bg-dark position-relative overflow-hidden pt-6" data-bs-theme="dark">
        ...
        <div class="container position-relative mt-5">
            ...
            <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
                ...
                <div class="text-body" role="contentinfo" aria-label="Copyright Information">
                    Copyright © 2025 PPTI | Pusat Pengembangan Teknologi Informasi Universitas
                    Negeri Surabaya. <br> Supported By PPTI Universitas Negeri Surabaya.
                </div>
                <!-- copyright links-->
                <!-- Language selector -->
                <div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
                    <a class="btn btn-sm btn-light mb-0 d-flex flex-column justify-content-center align-items-center"
                        ...
                        {{-- <i class="fas fa-chevron-up" style="font-size: 20px; color: #fff;" aria-hidden="true"></i> --}}
                        <i class="fas fa-chevron-up" style="font-size: 20px; color: #fff; margin-top: -5px;"
                            aria-hidden="true"></i>
                    </a>
                </div>
                ...
                {{-- <script src="https://code.responsivevoice.org/responsivevoice.js?key=nRBmRG0P"></script> --}}
