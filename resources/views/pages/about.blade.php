        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-8 text-center d-flex flex-column justify-content-center align-items-center">
                ...
                <h1 class="mb-0 lh-base">
                    <span style="color: #cfac32;">Visi dan Misi</span>
                </h1>
                <h2 class="mt-3">Universitas Negeri Surabaya</h2>
                <!-- Mengurangi jarak antara elemen dengan mt-1 -->
            </div>
            <!-- Hero content END -->
        </div>
        <!-- Hero END -->
...
<section class="pt-0">
    <div class="container">
        ...
        <div class="row">
            <!-- Service item -->
            <div class="col-12"> <!-- col-12 untuk mengambil lebar penuh -->
                <div class="card card-hover-shadow border h-100 w-100"> <!-- w-100 untuk lebar penuh -->
                    <!-- Card body -->
                    <div class="card-body p-4"> <!-- Padding tetap untuk menjaga teks rapi -->
                        <!-- Content -->
                        @foreach($visiMisi as $index)
                            <h2 class="mb-3" style="font-size: 1.75rem;">
                                <a href="#">{{ $index->nama }}</a>
                            </h2>
                            <p>{{ $index->deskripsi }}</p>
                        @endforeach
