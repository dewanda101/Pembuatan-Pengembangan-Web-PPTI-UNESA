            ...
            <div class="container pt-4 pt-lg-0">
                <div class="row g-4 g-sm-7">
                    ...
                    <div class="col-lg-8">
                        ...
                        <!-- Title -->
                        <h1 class="h2 mb-0">{{ $news->title }}</h1>
                        ...
                        <body>
                            <!-- Contoh ikon tanggal (kalender) -->
                            <span class="text-secondary opacity-3 mx-3">|</span>
                            <i class="bi bi-calendar"></i>{{ $news->created_at }} - {{ $news->category->category }}
                        ...
                        <!-- Image -->
                        <img src="{{ asset('storage/image/' . $news->image) }}" class="img-fluid rounded mt-5"
                            alt="blog-img">
