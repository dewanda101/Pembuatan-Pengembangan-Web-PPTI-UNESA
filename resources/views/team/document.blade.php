...
<title>PPTI | Pusat Pengembangan Teknologi Informasi
</title>
        ...
        <nav class="navbar navbar-expand-xl">
            <div class="container">
                ...
                <a class="navbar-brand me-0" href="#">
                    <img class="navbar-brand-item" style="height: 95px;" src="{{ asset('images/logo/Logo-Unesa.png') }}"
                        alt="logo">
                                ...
                                <div class="row g-xl-3">
                                    ...
                                    <div class="col-xl-8 d-none d-xl-block">
                                        <div class="d-flex gap-4">
                                            ...
                                            <div class="card bg-transparent">
                                                <!-- Image -->
                                                <img src="assets/images/portfolio/list/02.jpg" class="card-img"
                                                    alt="">
                                                <!-- Card body -->
                                                <div class="card-body px-0 text-start pb-0">

                                                    <a class="icon-link icon-link-hover stretched-link mb-0"
                                                        href="portfolio-case-studies-v2.html">Learn more<i
                            ...
                            <li class="mb-1">
                                ...
                                <script>
                                    ...
                                    function setTheme(theme) {
                                        const themeValue = theme === 'light' ? 'light' : (theme === 'dark' ? 'dark' : 'auto');
...
Main Banner START -->
        <section class="bg-dark pt-sm-8 pb-9" data-bs-theme="dark"
            style="display: flex; justify-content: center; align-items: center; height: 77vh;">
            <div class="container">
                <!-- Hero START -->
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 text-center d-flex flex-column justify-content-center align-items-center">
                        <!-- Title -->
                        <div
                            style="display: flex; justify-content: center; align-items: center; height: 80vh; flex-direction: column; text-align: center;">
                            <h1 class="mb-0 lh-base" style="font-size: 2.5rem; line-height: 1.3; font-weight: bold;">
                                Dokumentasi Direktur dengan Divisi Teknologi Informasi dan Pusat Data
                            </h1>
                            <h1 class="mb-0 lh-base"
                                style="font-size: 2.5rem; line-height: 1.3; color: #cfac32; margin-top: 0.5rem;">
...
Main Banner END -->
        ...
        <!-- Author and actions -->
        <div class="d-sm-flex justify-content-center justify-content-sm-between align-items-center text-start mt-5">
            <!-- Avatar -->
            <div class="d-flex justify-content-center align-items-center mb-5 mb-sm-0">
            ...
            <div class="d-flex justify-content-center align-items-center flex-wrap">
                <div class="dropdown">
                    <a href="#" class="text-secondary text-primary-hover" id="cardFeedAction"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="{{ asset('images/logo-update.jpg') }}" alt="Update Logo"
                            style="width: 30px; height: 30px; margin-right: 5px;">
                        <i class=""></i> 07 Oktober 2024 - Update
                    </a>
                </div>
            </div>
        ...
        <a href="#" class="text-secondary text-primary-hover mb-0"><i class=""></i></a>
        </div>
        </div>
        <!-- =======================
<!- Counter START -->
        <section>
            <!-- Judul Rektor -->
            <div class="text-center" style="background-color: #0b4d70; padding: 10px; margin-bottom: 20px;">
                <h2 style="color: white;">Direktur Kerjasama TI dan Pusat Data</h2>
            </div>

            <!-- Service list START -->
            <div class="row row-cols-1 text-center">
                @foreach ($direktur as $index => $team)
                    <div class="col mb-4">
                        <div class="card card-hover-shadow border h-100 p-4">
                            <div class="card-body p-0">
                                <figure class="mb-4">
                                    <img src="{{ asset('storage/image/' . $team->images) }}" alt="{{ $team->images }}"
                                        class="team-photo" width="170">
                                </figure>
                            </div>
                            <!-- Bagian bawah -->
                            <div
                                style="background-color: #cfac32; color: white; padding: 10px; width: 100%; height: 100px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                <h5 class="mb-2 text-uppercase"
                                    style="margin: 0; font-weight: bold; font-size: 15px;">{{ $team->nama }}</h5>
                                <p style="font-size: 13px; margin: 0; color: white;">{{ $team->deskripsi }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <!-- Tambahkan style untuk efek hover -->
            <style>
                .team-photo {
            ...
            <!-- Judul Kepala Rektor -->
            <div class="text-center" style="background-color: #0b4d70; padding: 10px; margin: 20px 0;">
                <h2 style="color: white;">Kepala Sub Direktorat TI dan Pusat Data</h2>
            </div>

            <!-- Service list START -->
            <div class="row row-cols-1 row-cols-sm-2 text-center">
                @foreach ($KepalaSub as $index => $team)
                    <div class="col mb-4">
                        <div class="card card-hover-shadow border h-100 p-4">
                            <!-- Bagian gambar -->
                            <div class="card-body p-0">
                                <figure class="mb-4">
                                    <img src="{{ asset('storage/image/' . $team->images) }}"
                                        alt="{{ $team->images }}" class="team-photo img-fluid"
                                        style="width: 170px;">
                                </figure>
                            </div>
                            <!-- Bagian bawah -->
                            <div
                                ...
                                <h5 class="mb-2 text-uppercase"
                                    style="margin: 0; font-weight: bold; font-size: 15px;">{{ $team->nama }}</h5>
                                <p style="font-size: 13px; margin: 0;">{{ $team->deskripsi }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak i gusti.jpg') }}" alt="Foto Kepala Rektor 2" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-2">I GUSTI LANANG PUTRA EKA PRISMANA, S.KOM., M.KOM.</h5> --}}
                    {{-- <p style="font-size: 14px;">Kepala Sub Direktorat Infrastruktur TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            </div>
            ...
            <!-- Judul Kepala Divisi -->
            <div class="text-center" style="background-color: #0b4d70; padding: 10px; margin: 20px 0;">
                <h2 style="color: white;">Kepala Seksi Divisi Informasi</h2>
            </div>
            <!-- Service list START -->
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 text-center">
                @foreach ($Kepaladivisi as $index => $team)
                    <div class="col mb-4">
                        <div class="card card-hover-shadow border h-100 p-4">
                            <div class="card-body p-0">
                                <figure class="mb-4">
                                    <img src="{{ asset('storage/image/' . $team->images) }}"
                                        alt="{{ $team->images }}" class="staff-photo img-fluid" width="170">
                                </figure>
                            </div>
                            <!-- Bagian bawah -->
                            <div
                                style="background-color: #cfac32; color: white; padding: 10px; width: 100%; min-height: 100px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                <h5 class="mb-2 text-uppercase"
                                    style="margin: 0; font-weight: bold; font-size: 15px;">{{ $team->nama }}</h5>
                                <p style="font-size: 13px; margin: 0; color: white;">{{ $team->deskripsi }}</p>
                            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak riana unesa.jpg') }}"alt="Foto Kepala Divisi 2" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">RIANA SUPRAPTO, S.KOM.</h5> --}}
                    {{-- <p>Kepala Seksi Transformasi Aplikasi Digital.</p> --}}
                </div>
            </div>
            </div>
            <!-- Service list END -->
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto bu windhi unesa.jpg') }}"alt="Foto Kepala Divisi 3" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">WINDY CHIKITA CORNIA PUTRI, S.KOM.</h5> --}}
                    {{-- <p>Kepala Seksi Analis Sistem dan Perancangan.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak yoyok unesa.jpg') }}" alt="Foto Kepala Divisi 4" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">YOYOK PRASTYO, S.KOM.</h5> --}}
                    {{-- <p>Kepala Seksi Pengembangan Sistem Informasi.</p> --}}
                </div>
            </div>
            </div>
            </div>
            ...
            <!-- Judul Staf PPTI -->
            <div class="text-center" style="background-color: #0b4d70; padding: 10px; margin: 20px 0;">
                <h2 style="color: white;">Staf Subdit TI dan Pusat Data</h2>
            </div>

            <!-- Service list START -->
            <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 text-center">
                <!-- Service item 1 -->
                @foreach ($staff as $index => $team)
                    <div class="col">
                        <div class="card card-hover-shadow border h-100 p-4">
                            <div class="card-body p-0">
                                <figure class="mb-4">
                            ...
                            <!-- Bagian bawah -->
                            <div
                                style="background-color: #cfac32; color: white; padding: 10px; width: 100%; min-height: 80px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                <h5 class="mb-2 text-uppercase"
                                    style="margin: 0; font-weight: bold; font-size: 16px;">{{ $team->nama }}</h5>
                                <p style="font-size: 14px; margin: 0;">{{ $team->deskripsi }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto bu triyah unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">TRIYAH FATMAWATI, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto bu marisa unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">MARISA ARNINDITA PALMA, S.E., M.M.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak java unesa.jpg') }}"class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">MUHAMMAD ISKANDAR JAVA, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak dimas unesa.jpg') }}" alt="Staf PPTI 5" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">DIMAS YOAN RIZALDI, <S class="KOM"></S>.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto pak novan unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">NOVAN BAGUS SETIAWAN, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto bu intan unesa.jpg') }}"class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">INTAN ALPIANA, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto bu anisa unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">ANISA CHAIRANI, A.MD.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
            ...
            <div class="col">
                ...
                <div class="card-body p-0">
                    <figure class="mb-4">
                        {{-- <img src="{{ asset('images/products/foto mas alviro unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;"> --}}
                    </figure>
                    {{-- <h5 class="mb-3">ALFIRO SIOWANTA PRATAMA, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p> --}}
                </div>
            </div>
            </div>
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak pepi unesa.jpg') }}"class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">FEBRY SAN PRATAMA, A.MD.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak farendi unesa.jpg') }}" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">FARENDI GIOTIVANO R.P., S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div>
...
<div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 text-center">
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('storage/image/'. $team->images) }}" alt="{{ $team->images }}" class="img-fluid" width="100">
                </figure>
				<h5 class="mb-2">{{ $team->nama }}</h5>
                <p style="font-size: 14px;">{{ $team->deskripsi }}</p>
            </div>
        </div>
    </div>
	@endforeach --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak wahyu unesa.jpg') }}"alt="Staf Data Center 2" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">WAHYU KHAMDANI, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak rizki unesa.jpg') }}" alt="Staf Data Center 3" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">MUHAMMAD RIZQI HIDAYATULLAH, A.MD.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak rachman unesa.jpg') }}" alt="Staf Data Center 4" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">RACHMAN NOVA SUMARTA, S.ST.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak ainul unesa.jpg') }}" alt="Staf Data Center 5" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">AINUL YAQIN, A.Md.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto bu anggi unesa.jpg') }}"alt="Staf Data Center 6" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">ANGGI TYA PITALOKA, A.Md.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak iksan unesa.jpg') }}" alt="Staf Data Center 7" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">IKSAN FEBRIANTO, S.KOM.</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div> --}}
    ...
    <div class="col">
        <div class="card card-hover-shadow border h-100 p-4">
            <div class="card-body p-0">
                <figure class="mb-4">
					<img src="{{ asset('images/products/foto pak aditya unesa.jpg') }}" alt="Staf Data Center 8" class="img-fluid" style="max-height: 200px; object-fit: cover;">
                </figure>
                <h5 class="mb-3">ADITYA MAULANA IBRAHIM</h5>
                <p>Staf Subdit TI dan Pusat Data.</p>
            </div>
        </div>
    </div>
