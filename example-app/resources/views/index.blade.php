	...
	<nav class="navbar navbar-expand-xl">
		<div class="container">
			...
			<a class="navbar-brand me-0" href="#">
				<img class="navbar-brand-item" style="height: 95px;" src="{{ asset('images/logo/Logo-Unesa.png')}}" alt="logo">
			</a>
			<!-- Logo END -->
			...
			<div class="navbar-collapse collapse" id="navbarCollapse">
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="about-v1.html" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Beranda</a>
						<div class=" ">
							<div class="row pt-2">
							
					<!-- Nav item -->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">Tentang Kami</a>
					...
					<!-- Nav item -->
					<li class="nav-item dropdown">
						<a class="" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
					...
					<!-- Nav item -->
					<li class="nav-item"> <a class="nav-link" href="contact-v1.blade.php">Contact us</a> </li>

					<!-- Nav item -->
					<li class="nav-item"> <a class="nav-link" href="docs/index.html" target="_blank">Document</a> </li>
				</ul>
			</div>
			<!-- Main navbar END -->
...
<section class="bg-dark pt-sm-8 pb-9" data-bs-theme="dark">
	<div class="container pt-4 pt-sm-0">
		...
		<div class="row g-4 g-xxl-5">
			...
			<div class="col-lg-8">
				<!-- Title -->
				<h1 class="mb-0 lh-base"> <span style="color: #cfac32;">Information Technology</span> Development Center Division</h1>
				<p class="mb-0 mt-4">Sebagai pusat layanan dan pengembangan teknologi informasi dan komunikasi, <br> yang handal dan berkualitas</p>
			</div>
			<!-- Hero content END -->
		</div>
		<!-- Hero END -->
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="card card-body bg-primary p-5 pt-8 overflow-hidden">
						...
						<!-- Content -->
						<h4 class="text-white fw-light">"UNESA Satu Langkah di Depan"</h4>
					</div>
				</div>
				...
				<div class="col-lg-8 position-relative ms-auto ps-xl-6 mt-6">
					...
					<div class="card card-body overflow-hidden p-0">
						<img src="images/about/gedung rektorat unesa (2) ai tulisan-.jpeg" class="card-img" alt="video-img">
						<div class="bg-overlay bg-dark opacity-3"></div>
						<div class="card-img-overlay d-flex p-3">
							<!-- Video button and link -->
							<div class="m-auto">
								<a href="https://youtu.be/s_preQ2AavQ?si=2Ls3sgbeCytL6JFX" class="btn btn-lg btn-white btn-round stretched-link mb-0" data-glightbox="" data-gallery="course-video">
...
<section class="pt-0">
		<div class="container">
			...
			<div class="inner-container text-center mb-4 mb-sm-6">
				<h2 class="mb-0">Information Technology Development Center Division
				</h2>
			</div>
					...
					<div class="card card-hover-shadow border h-100 p-4">
						...
						<div class="card-body p-0">
							...
							<figure class="text-primary mb-4">
								<svg style="color: #cfac32;" width="50" height="50" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<!-- Content -->
							<h5 class="mb-3"><a href="#">DIVISI INFRASTRUKTUR DAN JARINGAN KOMPUTER</a></h5>
							<p>Divisi ini terdiri dari Ketua Divisi dan Anggota yang bertanggung jawab terhadap layanan yang memadai dan berkualitas dalam masalah ketersedian infrastruktur jaringan.</p>
						</div>
				...
				<div class="col">
					<div class="card card-hover-shadow border h-100 p-4">
						...
						<div class="card-body p-0">
							...
							<!-- Content -->
							<h5 class="mb-3"><a href="#">DIVISI LAYANAN DAN KERJASAMA</a></h5>
						<p>Divisi ini memiliki tanggung jawab untuk menjalin kerjasama secara intensif baik pihak internal ( antar Unit kerja) maupun pihak ekternal ( stakeholder, penyedia jasa TIK) dan membuat program peningkatan kualitas sumber daya manusia di bidang TIK serta berfokus pada layanan TIK.</p>
						</div>
				...
				<div class="col">
					<div class="card card-hover-shadow border h-100 p-4">
						...
						<div class="card-body p-0">
							...
							<!-- Content -->
							<h5 class="mb-3"><a href="#">DIVISI PENGEMBANGAN SISTEM INFORMASI</a></h5>
							<p>Divisi pengembangan sistem informasi memiliki tanggung jawab untuk mengakomodasi semua ide pengembangan sistem informasi di universitas. </p>
						</div>
...
<section class="pt-0">
	<div class="container">
		...
		<div class="d-lg-flex justify-content-between align-items-center">
			<!-- Title -->
			<h4 class="mb-3 mb-lg-0">Berita Terbaru</h4>
	 	</div>
		...
		<div class="row g-4 g-sm-5 g-xl-7 mt-0">
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					<!-- Badge -->
					<div class="badge text-bg-dark position-absolute top-0 start-0 m-3"></div>

					<!-- Card image -->
					<img src="images/blog/4by3/berita 1ppti.jpg" class="card-img" alt="Blog-img">

					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">GENERAL SYMONTATION FLOW</a></h6>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="images/blog/4by3/berita 2ppti.jpg" class="card-img" alt="Blog-img">
						
					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">INTERNET ACCOUNT ACTIVATION TUTORIAL (UNESA WIFI) FOR UNESA ACADEMIC CITIZENS</a></h6>
						<p class="small mb-0"></p>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="images/blog/4by3/berita 3ppti.jpg" class="card-img" alt="Blog-img">

					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">UNESA Independent Campus Learning Information System</a></h6>
						<p class="small mb-0"></p>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="images/blog/4by3/berita 4ppti.jpg" class="card-img" alt="Blog-img">

					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">Google Drive Quota Limitations for Active Students and Alumni of Surabaya State University</a></h6>
						<p class="small mb-0"> </p>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="images/blog/4by3/berita 5ppti.jpg" class="card-img" alt="Blog-img">

					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">ONE UNESA</a></h6>
						<p class="small mb-0"></p>
					</div>
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					...
					<!-- Card image -->
					<img src="images/blog/4by3/berita 6ppti.jpg" class="card-img" alt="Blog-img">

					<!-- Card Body -->
					<div class="card-body px-2 pb-4">
						<!-- Title -->
						<h6 class="card-title mb-2"><a href="#">TUTORIAL FOR USING VERISA UNESA</a></h6>
						<p class="small mb-0"></p>
					</div>
...
<footer class="bg-dark position-relative overflow-hidden pt-6" data-bs-theme="dark">
	...
	<div class="position-absolute top-0 end-0 mt-n3 me-n4">
		<img src="images/elements/decoration-pattern-2.svg" style="opacity:0.05;" alt="">
	</div>
	...
	<div class="container position-relative mt-5">
		<div class="col-lg-3">
			<!-- logo -->
			<a class="me-0" href="#">
				<img style="height: 90px;" class="light-mode-item" src="images/logo/Logo-Unesa.png" alt="logo">
				<img style="height: 90px;"class="dark-mode-item" src="images/logo/Logo-Unesa.png" alt="logo">
			</a>
		</div>
				...
				<div class="col-lg-4">
					...
					<ul class="list-inline mb-0 mt-3">
						<li class="list-inline-item">
							<a class="btn btn-m btn-icon btn-light" href="https://web.facebook.com/universitasnegerisurabaya/?_rdc=1&_rdr"><i class="fab fa-fw fa-facebook-f lh-base"></i></a>
						</li>
						<li class="list-inline-item">
							<a class="btn btn-m btn-icon btn-light" href="https://www.instagram.com/official_ppti_unesa/"><i class="fab fa-fw fa-instagram lh-base"></i></a>
						</li>
						<li class="list-inline-item">
							<a class="btn btn-m btn-icon btn-light" href="https://twitter.com/Official_UNESA"><i class="fab fa-fw fa-twitter lh-base"></i></a>
						</li>
						<li class="list-inline-item">
							<a class="btn btn-m btn-icon btn-light" href="https://www.youtube.com/@pptiunesa8488"><i class="fab fa-fw fa-youtube lh-base"></i></a>
						</li>
					</ul>
				</div>
				<head>
				...
				<div class="col-lg-8">
					<div class="row g-4">
						...
						<div class="col-md-6">
							...
							<p>Gedung Rektorat Unesa Kampus Lidah Wetan Lt. 3 Sayap (PPTI/PUSKOM) Jl. Lidah Wetan, Surabaya (60213)</p>
						<div class="col-md-6 ">
						...
						<div class="col-md-6">
							...
							<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d4477.922826967872!2d112.67296544048394!3d-7.300544739540734!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fc4dfbef3eff%3A0xff531c44a03708c1!2sInformation%20Technology%20Development%20Center%20-%20State%20University%20of%20Surabaya!5e1!3m2!1sid!2sid!4v1725545117528!5m2!1sid!2sid"
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
			<!-- copyright text -->
			<div class="text-body"> Copyright © 2024 PPTI | Pusat Pengembangan Teknologi Informasi Universitas Negeri Surabaya. <br> Supported By PPTI Universitas Negeri Surabaya. </div>
			<!-- copyright links-->
			<!-- Language selector -->
			<div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
				<a class=" btn btn-sm btn-light mb-0" href="#" role="button" id="languageSwitcher" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: #cfac32;">
					Kembali ke Atas
				</a>
			</div>
